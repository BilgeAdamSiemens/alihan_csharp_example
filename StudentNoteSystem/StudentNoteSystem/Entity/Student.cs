...
namespace StudentNoteSystem.Entity
{
    public class Student : IComparable<Student>
    {
        ...
        public static Student Parse(String line)
        {
            ...
            int number = int.Parse(columns[0].Trim());
            double visaNote = double.Parse(columns[1].Trim());
            double finalNote = double.Parse(columns[2].Trim());
            return new Student
            {
                Number = number,
                VisaNote = visaNote,
        ...
        {
            return this.GetNoteAvg().CompareTo(other.GetNoteAvg());
        }
    }
}
